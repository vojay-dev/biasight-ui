    ...
    <header>
      <nav class="navbar w-full bg-base-100 bg-opacity-20 shadow-lg text-neutral-content backdrop-blur z-50 relative">
        <div class="navbar-start">
          <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-md dropdown-content mt-4 z-[1] p-2 shadow bg-base-100 bg-opacity-85 backdrop-blur rounded-box w-52">
              ...
              <li class="px-1">
                <a href="https://www.youtube.com/watch?v=LJg-o-oH4QU" target="_blank">
        ...
        <div class="navbar-end">
          <div v-if="usage != null && limit != null && usage < limit"><span class="badge badge-outline badge-info">Usage: {{ usage }} / {{ limit }}</span></div>
          <div v-else-if="usage != null && limit != null && usage >= limit"><span class="badge badge-outline badge-warning">Limit reached</span></div>
          <div v-else-if="error != null"><span class="badge badge-outline badge-error">API error</span></div>
        </div>
      </nav>
    </header>
    <main>
